...
func (_m *UserRepository) Login(username string, password string) (domain.User, error) {
...
func (_m *UserRepository) UpdateUser(id primitive.ObjectID, user domain.User) error {
